...
#define LIST_HEAD_INIT_ARRAY_8(name)\
        LIST_HEAD_INIT(name[0]), LIST_HEAD_INIT(name[1]),\
        LIST_HEAD_INIT(name[2]), LIST_HEAD_INIT(name[3]),\
        LIST_HEAD_INIT(name[4]), LIST_HEAD_INIT(name[5]),\
        LIST_HEAD_INIT(name[6]), LIST_HEAD_INIT(name[7])
...
#define list_for_each_sexy(pos, head, index_name)        \
        int index_name=0;      \
	for (pos = (head), index_name=0; pos != (head) || index_name==0; pos = pos->next, index_name++)
